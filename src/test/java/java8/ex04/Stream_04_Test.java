...
public class Stream_04_Test {
    ...
    public void test_concat() throws Exception {
        ...
        // on concatène les deux streams s1 et s2
    ...
    public void test_iterate() throws Exception {
        // on utilise la méthode "iterate" de Stream afin de rendre le test passant
        Stream<Integer> result1 = Stream.iterate(1, i -> i);
        Stream<Integer> result2 = Stream.iterate(1, i -> i++);
