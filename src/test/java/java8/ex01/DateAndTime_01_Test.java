...
public class DateAndTime_01_Test {
    ...
    public void test_date() {
        ...
        // on a modifie les paramètres pour que le test soit passant
        Date date = new Date(117, 2, 24, 1,2,3);

        assertThat(date.toString(), is("Fri Mar 24 01:02:03 CET 2017"));

        // une date est mutable... :-(
        // on modifie le jour de la date pour que le test soit passant
        date.setDate(25);
    ...
    public void test_calendar() throws Exception {
        ...
        // on modifie l'objet calendar pour que le test soit passant
