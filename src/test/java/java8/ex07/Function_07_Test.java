...
public class Function_07_Test {
    ...
    // tag::format[]
    // renvoie une chaîne de caractères de la forme "(<nb1><symbol><nb2>)=<resultat>"
    // ex. "(10+11)=21", "(5-2)=3"
    ...
    // on définit sum pour que le test test_format_sum() soit passant
    ...
    // on définit substract afin que le test test_format_subtract() soit passant
